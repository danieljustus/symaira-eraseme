...
func writeFixture() {
	cases := []fixtureCase{
		...
		{Name: "unknown_method_notification_has_no_response", Request: `{"jsonrpc":"2.0","method":"other"}`},
		{Name: "initialize_params_scalar_notification_has_no_response", Request: `{"jsonrpc":"2.0","method":"initialize","params":1}`},
		{Name: "initialize_params_array_notification_has_no_response", Request: `{"jsonrpc":"2.0","method":"initialize","params":[]}`},
		{Name: "non_object_scalar_is_invalid_request", raw: []byte(`1`)},
		{Name: "non_object_string_is_parse_error", raw: []byte(`"hello"`)},
		{Name: "non_object_array_is_parse_error", raw: []byte(`[1,2]`)},
		{Name: "non_object_true_is_parse_error", raw: []byte(`true`)},
		{Name: "non_object_null_is_parse_error", raw: []byte(`null`)},
		{Name: "shorter_field_name_prefix_is_ignored", Request: `{"jsonrpc":"2.0","id":1,"method":"initialize","json":1}`},
		{Name: "string_id_with_surrogate_pair", Request: `{"jsonrpc":"2.0","id":"\ud83d\ude00","method":"initialize"}`},
		{Name: "unknown_field_nested_containers_are_ignored", Request: `{"jsonrpc":"2.0","id":1,"method":"initialize","unknown":{"a":[1,{"b":"x"},[2,3]],"c":true,"d":null,"e":"s"}}`},
		{Name: "unknown_field_deep_array_is_ignored", Request: `{"jsonrpc":"2.0","id":1,"method":"initialize","unknown":[[[[1]]]]}`},
		{Name: "unknown_field_escaped_string_is_ignored", Request: `{"jsonrpc":"2.0","id":1,"method":"initialize","unknown":"\u0041\n"}`},
		{Name: "unknown_field_empty_containers_are_ignored", Request: `{"jsonrpc":"2.0","id":1,"method":"initialize","unknown":{},"unknown2":[]}`},
		{Name: "initialize_fractional_id_uses_go_float_text", Request: `{"jsonrpc":"2.0","id":100.5,"method":"initialize"}`},
		{Name: "initialize_negative_fractional_id_uses_go_float_text", Request: `{"jsonrpc":"2.0","id":-0.5,"method":"initialize"}`},
		{Name: "initialize_small_fraction_id_uses_go_float_text", Request: `{"jsonrpc":"2.0","id":0.001,"method":"initialize"}`},
		{Name: "initialize_negative_zero_float_id_is_preserved", Request: `{"jsonrpc":"2.0","id":-0.0,"method":"initialize"}`},
		{Name: "initialize_params_nested_object_values", Request: `{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"a":{"b":1},"c":[1,2]}}`},
		{Name: "whitespace_padded_request_is_accepted", raw: []byte("   {\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"initialize\"}   ")},
		{Name: "trailing_content_after_object_is_parse_error", raw: []byte(`{"jsonrpc":"2.0","id":1,"method":"initialize"} x`)},
		{Name: "string_id_with_newline_tab_quote_backslash_escapes", Request: "{\"jsonrpc\":\"2.0\",\"id\":\"\\n\\t\\\"\\\\\",\"method\":\"initialize\"}"},
		{Name: "string_id_with_solidus_escape", Request: "{\"jsonrpc\":\"2.0\",\"id\":\"\\/\",\"method\":\"initialize\"}"},
		{Name: "string_id_with_control_character_escapes", Request: "{\"jsonrpc\":\"2.0\",\"id\":\"\\b\\f\\r\",\"method\":\"initialize\"}"},
		{Name: "string_id_with_unicode_escape", Request: "{\"jsonrpc\":\"2.0\",\"id\":\"\\u0041\",\"method\":\"initialize\"}"},
		{Name: "string_id_with_invalid_escape_is_invalid_request", Request: "{\"jsonrpc\":\"2.0\",\"id\":\"\\x\",\"method\":\"initialize\"}"},
		{Name: "method_with_invalid_escape_is_invalid_request", Request: "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"a\\x\"}"},
		{Name: "jsonrpc_with_invalid_escape_is_invalid_request", Request: "{\"jsonrpc\":\"2.\\x0\",\"id\":1,\"method\":\"initialize\"}"},
	}
