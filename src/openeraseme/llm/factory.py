...
_PROVIDERS: dict[str, tuple[str, str, str, str]] = {
    "anthropic": (
        "openeraseme.llm.anthropic_client",
        "AnthropicClient",
        "ANTHROPIC_API_KEY",
        "claude-3-5-sonnet-latest",
    ),
    "openai": (
        "openeraseme.llm.openai_client",
        "OpenAIClient",
        "OPENAI_API_KEY",
        "gpt-4o",
    ),
    "ollama": (
        "openeraseme.llm.ollama_client",
        "OllamaClient",
...
_ENV_PROVIDER = "OPENERASEME_LLM_PROVIDER"
_ENV_MODEL = "OPENERASEME_LLM_MODEL"
...
def create_llm_client(
    ...
    Parameters:
        provider:  Provider name (e.g. "anthropic").
                   Falls back to `OPENERASEME_LLM_PROVIDER` env var,
                   then to "anthropic".
        model:     Model name. Falls back to `OPENERASEME_LLM_MODEL`
